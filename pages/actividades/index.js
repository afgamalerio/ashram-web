...
const Activities = () => {
  return (
    <>
      <Head>
        <title>Ashram - Actividades</title>
        <meta
          name="description"
        ...
        <meta property="og:url" content="https://ashram.ar/actividades" />
            ...
            <div className="col-sm-12 col-md-4 col-lg-4 card">
              ...
              <div className="card__content">
                ...
                <p className="card__content--text">
                  ...
                  por el cuerpo en su proposito de restablecer la salud, la vitalidad, el bienestar
                  y la alegría.
                </p>
            ...
            <div className="col-sm-12 col-md-4 col-lg-4 card">
              ...
              <div className="card__content">
                ...
                <p className="card__content--text">
                  ...
                  filosofia de las Flores de Bach, con el enfoque de la personalidad que nos otorga
                  el Eneagrama, y tambien con meditación y pranayama. Cada taller es una oportunidad
                  de verse con una nueva y mejor mirada, que amplia el autoconocimento y las
            ...
            <div className="col-sm-12 col-md-4 col-lg-4 card">
              ...
              <div className="card__content">
                ...
                <p className="card__content--text">
                  ...
                  guiadas para aplicar en la vida cotidiana en casos de insomnio, inquietud,
                  ansiedad, o molestias fisicas.
                </p>
                <a href="mailto:ashramvirtual@gmail.com" className="card__content--button">
                  Quiero más información
                </a>
