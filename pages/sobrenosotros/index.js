...
const About = () => {
  return (
    <>
      <Head>
        <title>Ashram - Sobre Nosotros</title>
        <meta
          name="description"
        ...
        <meta property="og:url" content="https://ashram.ar/sobrenosotros" />
          ...
          <section className="about" id="about__ashram">
            ...
            <div className="about__content">
              ...
              <p className="about__content--text">
                En Ashram proponemos que cuando llegues aquí comiences a reconocer tu propia
                Maestría Interior. Cada SER trae a este plano una misión única e irrepetible y los
                dones en la exacta medida de esa misión. Cada propuesta que encuentres aquí te
                permitirá avanzar en el rumbo del Autoconocimiento, autoaceptacion, autosanacion.
                <br />
              ...
              <ul className="about__content--list">
                ...
                <li>
                  Y si querés conocer nuestro espacio físico amoroso y cuidado, hoy es en calle 9
                  nro 1237 de General Pico
                </li>
              </ul>
          ...
          <section className="about" id="about__founder">
            ...
            <div className="about__content">
              ...
              <p className="about__content--text">
                ...
                Profesores de Yoga para lo cual siguió el programa de la ABY (Asociación Bonaerense
                de Yoga ubicada en la ciudad de La Plata y que dirige el Maestro Ricardo García) A
                partir de 2005, y cada año desde entonces, hay nuevos Instructores y Profesores de
                Yoga que se preparan en ASHRAM para sostener una práctica diaria o sadhana que les
                mantenga en el camino de salud, bienestar y evolución que propone Yoga, y para
                compartir estas prácticas en clases individuales y grupales.
              </p>
              ...
              <p className="about__content--text">
                ...
                entregando las iniciaciones de primer segundo tercer nivel y maestría desde 2011 a
                más de un centenar de seres que canalizan sanación y alivio por imposición de manos
              </p>
              ...
              <p className="about__content--text">
                ...
                Foundation Registered Practitioner Y a partir de 2018, con el aval de la trayectoria
                y experiencia, formar grupos de Terapeutas Florales en General Pico.
              </p>
