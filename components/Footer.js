        ...
        <div className="row justify-content-around align-items-stretch">
          <div className="col-12 col-md-6 footer__information">
            ...
            <p className="footer__information--text">
              Ashram es un espacio de cremimiento personal fundado en 2006 por Silvia Gamalerio.
            </p>

            <p className="footer__information--text">
              Te invitamos a conocerlo en calle 9, numero 1237, General Pico, La Pampa, Argentina.
            </p>
          </div>

          <div className="col-12 col-md-6 footer__contactinfo align-self-end">
